...
rsync -avz --delete --rsync-path="sudo rsync" \
pi@192.168.137.49:/usr/share/pkgconfig/ \
...
qt6/pi/ \
pi@192.168.137.49:/usr/local/qt6/
```
...
```bash
cd ~/Qt6Cross_Bookworm_651/test_qt_arm64/build && \
scp test_qt_arm64 pi@192.168.137.49:/home/pi/
```
